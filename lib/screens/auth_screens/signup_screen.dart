...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future addUserDetails(String firstName, String lastName, String userEmail, String userPassword) async{
                                ...
                                Container(
                                  ...
                                  child: CustomInputfield(
                                    ...
                                    validator: (value) {
                                      ...
                                      else if(!nameRegExp.hasMatch(value) || numberRegExp.hasMatch(value)){
                                    ...
                                    if(user !=null){
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(
                                          ...
                                          content: AwesomeSnackbarContent(
                                            color: btnColor,
                                            title: "Signed Up", 
                                            message: "succesful process, Have Fun!!", 
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(
                                          backgroundColor: Colors.transparent,
                                          content: AwesomeSnackbarContent(
                                            title: "Cannot Sign Up, Try again", 
                                            message: "please, check your internet connectivity first", 
